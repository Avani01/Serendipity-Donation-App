...
public class IndiaToy_rvAdapter extends RecyclerView.Adapter<IndiaToy_rvAdapter.ToyViewHolder> {

    ArrayList<Toy_org> toy_org = new ArrayList<>();
    private Context toy_context;

    public IndiaToy_rvAdapter(Context toy_context){
        this.toy_context = toy_context;
    }

    public IndiaToy_rvAdapter() {

    }

    @NonNull
    @Override
    public IndiaToy_rvAdapter.ToyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        IndiaToy_rvAdapter.ToyViewHolder holder = new IndiaToy_rvAdapter.ToyViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull IndiaToy_rvAdapter.ToyViewHolder holder, @SuppressLint("RecyclerView") int position) {
