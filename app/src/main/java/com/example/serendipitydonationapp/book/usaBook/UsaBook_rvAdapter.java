...
public class UsaBook_rvAdapter extends RecyclerView.Adapter<UsaBook_rvAdapter.BookViewHolder> {
    ArrayList<Book_org> book_org = new ArrayList<>();
    private Context book_context;

    public UsaBook_rvAdapter (Context book_context){
        this.book_context = book_context;
    }

    public UsaBook_rvAdapter() {

    }

    @NonNull
    @Override
    public UsaBook_rvAdapter.BookViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        UsaBook_rvAdapter.BookViewHolder holder = new UsaBook_rvAdapter.BookViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull UsaBook_rvAdapter.BookViewHolder holder, @SuppressLint("RecyclerView") int position) {
