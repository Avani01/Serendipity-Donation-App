...
public class IndiaBook_rvAdapter extends RecyclerView.Adapter<IndiaBook_rvAdapter.BookViewHolder> {

    ArrayList<Book_org> book_org = new ArrayList<>();
    private Context book_context;

    public IndiaBook_rvAdapter (Context book_context){
        this.book_context = book_context;
    }

    public IndiaBook_rvAdapter() {

    }

    @NonNull
    @Override
    public IndiaBook_rvAdapter.BookViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        IndiaBook_rvAdapter.BookViewHolder holder = new IndiaBook_rvAdapter.BookViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull IndiaBook_rvAdapter.BookViewHolder holder, @SuppressLint("RecyclerView") int position) {
