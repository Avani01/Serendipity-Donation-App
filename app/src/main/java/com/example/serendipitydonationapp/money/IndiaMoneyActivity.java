...
public class IndiaMoneyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_india_money);
        ...
        IndiaMoney_rvAdapter adapter = new IndiaMoney_rvAdapter(this);
