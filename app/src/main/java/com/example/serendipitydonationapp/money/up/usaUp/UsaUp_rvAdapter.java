...
public class UsaUp_rvAdapter extends RecyclerView.Adapter<UsaUp_rvAdapter.UpViewHolder> {

    ArrayList<Up_org> up_org = new ArrayList<>();
    private Context up_context;

    public UsaUp_rvAdapter (Context up_context){
        this.up_context = up_context;
    }

    public UsaUp_rvAdapter() {

    }

    @NonNull
    @Override
    public UsaUp_rvAdapter.UpViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        UsaUp_rvAdapter.UpViewHolder holder = new UsaUp_rvAdapter.UpViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull UsaUp_rvAdapter.UpViewHolder holder, @SuppressLint("RecyclerView") int position) {
