...
public class IndiaChild_rvAdapter extends RecyclerView.Adapter<IndiaChild_rvAdapter.ChildViewHolder> {

    ArrayList<Child_org> child_org = new ArrayList<>();
    private Context child_context;

    public IndiaChild_rvAdapter (Context child_context){
        this.child_context = child_context;
    }

    public IndiaChild_rvAdapter() {

    }

    @NonNull
    @Override
    public IndiaChild_rvAdapter.ChildViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        IndiaChild_rvAdapter.ChildViewHolder holder = new IndiaChild_rvAdapter.ChildViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull IndiaChild_rvAdapter.ChildViewHolder holder, @SuppressLint("RecyclerView") int position) {
