package com.example.serendipitydonationapp.money.pod.indiaPod;
...
import com.example.serendipitydonationapp.money.pod.usaPod.UsaPod_rvAdapter;

import java.util.ArrayList;

public class IndiaPod_rvAdapter extends RecyclerView.Adapter<IndiaPod_rvAdapter.PodViewHolder> {

    ArrayList<Pod_org> pod_org = new ArrayList<>();
    private Context pod_context;

    public IndiaPod_rvAdapter (Context pod_context){
        this.pod_context = pod_context;
    }

    public IndiaPod_rvAdapter() {

    }

    @NonNull
    @Override
    public IndiaPod_rvAdapter.PodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        IndiaPod_rvAdapter.PodViewHolder holder = new IndiaPod_rvAdapter.PodViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull IndiaPod_rvAdapter.PodViewHolder holder, @SuppressLint("RecyclerView") int position) {
