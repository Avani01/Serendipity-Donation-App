...
public class IndiaWomen_rvAdapter extends RecyclerView.Adapter<IndiaWomen_rvAdapter.WomenViewHolder> {

    ArrayList<Women_org> women_org = new ArrayList<>();
    private Context women_context;

    public IndiaWomen_rvAdapter (Context women_context){
        this.women_context = women_context;
    }

    public IndiaWomen_rvAdapter() {

    }

    @NonNull
    @Override
    public IndiaWomen_rvAdapter.WomenViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        IndiaWomen_rvAdapter.WomenViewHolder holder = new IndiaWomen_rvAdapter.WomenViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull IndiaWomen_rvAdapter.WomenViewHolder holder, @SuppressLint("RecyclerView") int position) {
