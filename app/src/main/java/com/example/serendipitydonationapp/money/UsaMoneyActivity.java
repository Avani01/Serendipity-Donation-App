...
public class UsaMoneyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usa_money);
        ...
        UsaMoney_rvAdapter adapter = new UsaMoney_rvAdapter(this);
