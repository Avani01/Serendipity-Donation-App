...
public class IndiaUp_rvAdapter extends RecyclerView.Adapter<IndiaUp_rvAdapter.UpViewHolder> {

    ArrayList<Up_org> up_org = new ArrayList<>();
    private Context up_context;

    public IndiaUp_rvAdapter (Context up_context){
        this.up_context = up_context;
    }

    public IndiaUp_rvAdapter() {

    }

    @NonNull
    @Override
    public IndiaUp_rvAdapter.UpViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        IndiaUp_rvAdapter.UpViewHolder holder = new IndiaUp_rvAdapter.UpViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull IndiaUp_rvAdapter.UpViewHolder holder, @SuppressLint("RecyclerView") int position) {
