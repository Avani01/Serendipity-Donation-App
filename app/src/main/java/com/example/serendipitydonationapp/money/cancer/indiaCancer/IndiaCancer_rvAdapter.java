package com.example.serendipitydonationapp.money.cancer.indiaCancer;
...
import com.example.serendipitydonationapp.money.cancer.usaCancer.UsaCancer_rvAdapter;

import java.util.ArrayList;

public class IndiaCancer_rvAdapter extends RecyclerView.Adapter<IndiaCancer_rvAdapter.CancerViewHolder> {

    ArrayList<Cancer_org> cancer_org = new ArrayList<>();
    private Context cancer_context;

    public IndiaCancer_rvAdapter (Context cancer_context){
        this.cancer_context = cancer_context;
    }

    public IndiaCancer_rvAdapter() {

    }

    @NonNull
    @Override
    public IndiaCancer_rvAdapter.CancerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        IndiaCancer_rvAdapter.CancerViewHolder holder = new IndiaCancer_rvAdapter.CancerViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull IndiaCancer_rvAdapter.CancerViewHolder holder, @SuppressLint("RecyclerView") int position) {
