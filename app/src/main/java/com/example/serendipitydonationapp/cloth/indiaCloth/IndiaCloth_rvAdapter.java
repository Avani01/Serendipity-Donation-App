package com.example.serendipitydonationapp.cloth.indiaCloth;
...
import com.example.serendipitydonationapp.cloth.usaCloth.UsaCloth_rvAdapter;

import java.util.ArrayList;

public class IndiaCloth_rvAdapter extends RecyclerView.Adapter<IndiaCloth_rvAdapter.ClothViewHolder> {

    ArrayList<Cloth_org> cloth_org = new ArrayList<>();
    private Context cloth_context;

    public IndiaCloth_rvAdapter (Context cloth_context){
        this.cloth_context = cloth_context;
    }

    public IndiaCloth_rvAdapter() {

    }

    @NonNull
    @Override
    public IndiaCloth_rvAdapter.ClothViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        IndiaCloth_rvAdapter.ClothViewHolder holder = new IndiaCloth_rvAdapter.ClothViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull IndiaCloth_rvAdapter.ClothViewHolder holder, @SuppressLint("RecyclerView") int position) {
