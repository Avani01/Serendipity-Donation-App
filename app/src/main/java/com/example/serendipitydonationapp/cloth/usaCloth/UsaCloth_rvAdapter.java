...
public class UsaCloth_rvAdapter extends RecyclerView.Adapter<UsaCloth_rvAdapter.ClothViewHolder> {

    ArrayList<Cloth_org> cloth_org = new ArrayList<>();
    private Context cloth_context;

    public UsaCloth_rvAdapter (Context cloth_context){
        this.cloth_context = cloth_context;
    }

    public UsaCloth_rvAdapter() {

    }

    @NonNull
    @Override
    public UsaCloth_rvAdapter.ClothViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        UsaCloth_rvAdapter.ClothViewHolder holder = new UsaCloth_rvAdapter.ClothViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull UsaCloth_rvAdapter.ClothViewHolder holder, @SuppressLint("RecyclerView") int position) {
