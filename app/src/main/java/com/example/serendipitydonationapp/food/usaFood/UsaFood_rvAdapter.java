...
public class UsaFood_rvAdapter extends RecyclerView.Adapter<UsaFood_rvAdapter.FoodViewHolder> {

    ArrayList<Food_org> food_org = new ArrayList<>();
    private Context food_context;

    public UsaFood_rvAdapter (Context food_context){
        this.food_context = food_context;
    }

    public UsaFood_rvAdapter() {

    }

    @NonNull
    @Override
    public UsaFood_rvAdapter.FoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_org_list, parent, false);
        UsaFood_rvAdapter.FoodViewHolder holder = new UsaFood_rvAdapter.FoodViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull UsaFood_rvAdapter.FoodViewHolder holder, @SuppressLint("RecyclerView") int position) {
